...
echo "Что произошло? Никто ничего не знал о libhello_shared.so, но мы загрузили функцию из нее в оперативку прямо во время исполнения и, таким образом, смогли ее использовать."
